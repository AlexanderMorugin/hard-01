...
const darkPopup = document.querySelector('.popup');
const darkPopupLinkRoad = document.querySelector('.popup__link_road');
const darkPopupLinkBike = document.querySelector('.popup__link_bike');
const darkPopupLinkTraining = document.querySelector('.popup__link_training');
const darkPopupClose = document.querySelector('.popup__close');
const darkPopupTogglePanel = document.querySelector('.popup__toggle-panel');
// Theme Dark Page
const page = document.querySelector('.page');
// Header
const headerStickOne = document.querySelector('.header__stick_type_one');
const headerStickTwo = document.querySelector('.header__stick_type_two');
const headerStickThree = document.querySelector('.header__stick_type_three');
// Theme Dark Header
...
// Функции Header
function themeHeaderStickOne(headerStickOne) {
  headerStickOne.classList.toggle('header__stick_type_one_theme_dark');
};

function themeHeaderStickTwo(headerStickTwo) {
  headerStickTwo.classList.toggle('header__stick_type_two_theme_dark');
};

function themeHeaderStickThree(headerStickThree) {
  headerStickThree.classList.toggle('header__stick_type_three_theme_dark');
};
...
popupToggleSwitch.addEventListener('click', () => {
  themeDarkPopup(darkPopup);
  themeDarkPopupLinkRoad(darkPopupLinkRoad);
  themeDarkPopupLinkBike(darkPopupLinkBike);
  themeDarkPopupLinkTraining(darkPopupLinkTraining);
  themeDarkPopupClose(darkPopupClose);
  ...
  themeHeaderLink(headerLinkBike);
  themeHeaderLink(headerLinkTraining);
  themeHeaderStickOne(headerStickOne);
  themeHeaderStickTwo(headerStickTwo);
  themeHeaderStickThree(headerStickThree);    
